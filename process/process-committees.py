...
COMMITTEE_WHITELIST = [
    ...
    "joint-appropriations-section-a",
    "joint-appropriations-section-b",
    "joint-appropriations-section-c",
    "joint-appropriations-section-d",
    "joint-appropriations-section-e",
    "joint-appropriations-section-f",
    ...
    "senate-ethics",
    "senate-executive-review-committee",
    "senate-fiance-and-claims",
...
def process_committees(session_id):
    ...
    for filename in os.listdir(committees_dir):
        ...
        if COMMITTEE_WHITELIST and committee_key not in COMMITTEE_WHITELIST:
            continue
